...
public:
  ...
  virtual int		GetRecordingAmount(void);
  ...
  virtual PVR_ERROR DeleteTimer(const PVR_TIMER &timer);
  virtual CStdString DateTimeToString(time_t time);
